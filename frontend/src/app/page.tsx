  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-cream">
        <div className="text-espresso text-lg">
          Loading...
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-cream">
        ...
        <main className="pt-24 pb-16">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-terracotta font-medium mb-6 hover:underline"
            >
              ← Back to Home
            </Link>
            ...
            <div className="bg-white rounded-2xl p-6 border border-[var(--border)]">
              ...
              {dashboardData?.registries &&
              dashboardData.registries.length > 0 ? (
